...
| [xquik-x-automation](packages/marketing/xquik-x-automation/SKILL.md) | Uses Xquik for source-backed X/Twitter research, monitoring, exports, and posting workflows | Searching X data, setting up monitors, exporting results, or connecting agents through Xquik MCP |
