...
license: MIT
compatibility: Codex, Claude Code, Cursor, and other Agent Skills compatible tools. Building the vertical slice requires a writable repository and a stack compatible with the generated implementation.
metadata:
  author: Oleg Koval
  tags:
    - mvp
